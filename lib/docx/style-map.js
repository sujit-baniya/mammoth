...
var schema = "http://schemas.heweifeng.cn/mammoth-plus/style-map";
var styleMapPath = "mammoth-plus/style-map";
    ...
    return docxFile.read(path, "utf8")
        ...
        .then(function(typesElement) {
            ...
            addOrUpdateElement(children, overrideName, "PartName", {
                ...
                "ContentType": "text/prs.mammoth-plus.style-map"
            });
