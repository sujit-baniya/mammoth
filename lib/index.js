...
exports.styleMapping = function() {
    throw new Error('Use a raw string instead of mammoth-plus.styleMapping e.g. "p[style-name=\'Title\'] => h1" instead of mammoth-plus.styleMapping("p[style-name=\'Title\'] => h1")');
};
